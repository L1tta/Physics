...
void Physics::GizmosUpdate()
{
	...
	c1p.z = c1.z;
	Gizmos::addAABBFilled(c1p, vec3(1, 1, 1), vec4(1, 1, 1, 1));
	Gizmos::addAABB(c1p, vec3(1.001, 1.001, 1.001), vec4(0, 0, 0, 1));
	...
	c2p.z = c2.z;
	Gizmos::addAABBFilled(c2p, vec3(1, 1, 1), vec4(1, 1, 1, 1));
	Gizmos::addAABB(c2p, vec3(1.001, 1.001, 1.001), vec4(0, 0, 0, 1));
	...
	c3p.z = c3.z;
	Gizmos::addAABBFilled(c3p, vec3(1, 1, 1), vec4(1, 1, 1, 1));
	Gizmos::addAABB(c3p, vec3(1.001, 1.001, 1.001), vec4(0, 0, 0, 1));
	...
	c4p.z = c4.z;
	Gizmos::addAABBFilled(c4p, vec3(1, 1, 1), vec4(1, 1, 1, 1));
	Gizmos::addAABB(c4p, vec3(1.001, 1.001, 1.001), vec4(0, 0, 0, 1));
}
